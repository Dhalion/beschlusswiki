<template>
    <div class="flex flex-col sm:w-3/4 ml-3 sm:mx-auto mt-5 text-black">

        <!--* Header -->
        <div v-if="!pending && !error" class="flex justify-start">
        ...
        <div v-for="resolution in category?.resolutions" :key="resolution">
            <MainSearchResultResolutionCard :id="resolution" />
        </div>
    </div>
    <UNotifications />
</template>
